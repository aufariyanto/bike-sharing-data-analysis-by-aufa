...
def create_weather_rent_df(df):
       # Mapping numerical weather values to descriptive labels
    weather_map = {
    ...
    weather_df = df.groupby(by='weathersit').agg({'cnt': 'mean'}).reset_index()
    weather_df['weathersit_label'] = weather_df['weathersit'].map(weather_map)
    return weather_df
