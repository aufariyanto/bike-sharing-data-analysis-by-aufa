...
with st.sidebar:
    ...
    nama = st.text_input("Nama Lengkap", value="Aufa Muhammad Yogi Riyanto")
    email = st.text_input("Alamat Email", value= "CDCC180D6Y1537@student.devacademy.id")
    
    st.markdown("---")
    
    # 3. Filter Rentang Waktu (Terkunci di 2011-2012)
...
# Menampilkan Identitas dari Sidebar
st.info(f"Proyek Analisis Data dikerjakan oleh: **{nama}** ({email})")
...
with col_a:
    ...
    sns.barplot(x='weathersit', y='cnt', data=weather_rent_df, hue='weathersit', 
...
with col_b:
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    sns.barplot(x='season', y='cnt', data=season_rent_df, hue='season', 
